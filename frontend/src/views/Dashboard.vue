      ...
      <svg
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <path
            ...
            fill="#8d9998"
            id="IconifyId17ecdb2904d178eab26147"></path>
          <path
          ...
          <g fill="#8d9998">
            <path
              d="M40.5 58.4c1.2-1.6 2.7-2.9 4.2-4.2c1.5-1.3 3-2.6 4.5-4c1.4-1.4 2.8-3 3.8-4.8c1-1.8 1.5-3.9 1.3-5.9c-.2 2-.9 3.9-2 5.5s-2.4 3.1-3.8 4.5s-2.9 2.7-4.3 4.2c-1.5 1.3-2.8 2.9-3.7 4.7"></path>
            <path
              d="M39.3 51.2c.4-1.1 1-2 1.7-2.9c.7-.9 1.4-1.7 2.2-2.6c.7-.9 1.5-1.8 2-2.8c.6-1 .9-2.3.7-3.4c-.2 1.1-.7 2.1-1.4 3c-.6.9-1.4 1.7-2.1 2.6c-.7.9-1.5 1.8-2.1 2.8c-.6 1-1 2.2-1 3.3"></path>
          </g>
          <path
          ...
          <path
            ...
            fill="#8d9998"></path>
          <use xlink:href="#IconifyId17ecdb2904d178eab26147"></use>
        </g>
      </svg>
...
.revenue {
  ...
  background-color: rgba(102, 200, 128, 0.8);
